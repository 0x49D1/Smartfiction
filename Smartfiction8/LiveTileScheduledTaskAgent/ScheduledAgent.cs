    ...
    public class ScheduledAgent : ScheduledTaskAgent
    {
        ...
        protected override void OnInvoke(ScheduledTask task)
        {
            ...
            if (null != tile)
            {
                ...
                data.BackTitle = "";
                data.BackBackgroundImage = new Uri("/Images/black.png", UriKind.Relative);
                data.BackContent = task.Description.Substring(0,task.Description.IndexOf("is")); // take just TITLE from description
                // update tile
                tile.Update(data);
            }
#if DEBUG_AGENT
